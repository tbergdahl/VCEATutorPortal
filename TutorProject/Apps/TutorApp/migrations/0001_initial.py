# Generated by Django 4.2.6 on 2023-11-30 00:24
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TutorFrequencyPair',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('frequency', models.IntegerField(default=0)),
                ('time_period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TutorApp.tutoringtimeperiod')),
        ...
        migrations.AddField(
            model_name='tutoringtimeperiod',
            name='tutors',
            field=models.ManyToManyField(related_name='time_periods', through='TutorApp.TutorFrequencyPair', to='TutorApp.tutor'),
        ),
        migrations.CreateModel(
